...
INSERT INTO `page` (`ID_page`, `Title`, `ID_user`, `Status`, `Content`, `Rank`, `Tags`, `Menu`) VALUES
(1, 'Students', 2, 'posted', 'hjk', 0, 'student', 'People'),
(2, 'Test', 1, 'not posted', 'jkhfg', 2, 'test', 'Finances');
